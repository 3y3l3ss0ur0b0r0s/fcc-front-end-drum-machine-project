...
class DrumMachine extends React.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/(
      React.createElement("div", { id: "drum-machine", className: "container-fluid", onKeyPress: this.handleKeyPress, style: { backgroundImage: this.state.currentScheme.dmColor } }, /*#__PURE__*/
      React.createElement("div", { class: "topPanel" }, /*#__PURE__*/
      React.createElement("button", { className: "schemeButton", id: "pink", onClick: this.changeScheme, style: { backgroundImage: this.state.currentScheme.dpColor, color: this.state.currentScheme.fontColor } }, "Pink"), /*#__PURE__*/
      React.createElement("button", { className: "schemeButton", id: "grey", onClick: this.changeScheme, style: { backgroundImage: this.state.currentScheme.dpColor, color: this.state.currentScheme.fontColor } }, "Grey"), /*#__PURE__*/
      React.createElement("button", { className: "schemeButton", id: "dark", onClick: this.changeScheme, style: { backgroundImage: this.state.currentScheme.dpColor, color: this.state.currentScheme.fontColor } }, "Dark"), /*#__PURE__*/
      React.createElement("div", { id: "display" }, this.state.displayText)), /*#__PURE__*/

      React.createElement("div", { id: "button-grid", className: "grid-container" },
      // JSX TO RENDER DRUMPADS 
      Object.keys(this.state.drumPads).map((key) => /*#__PURE__*/
      React.createElement("button", { className: "drum-pad", id: key.toLowerCase(), onClick: this.handleClick, style: { backgroundImage: this.state.currentScheme.dpColor, color: this.state.currentScheme.fontColor } }, /*#__PURE__*/React.createElement("audio", { className: "clip", src: drumPads[key].audio, id: key }), key)
      // END ARROW FUNCTION
      ) // END MAP FUNCTION
      )));
